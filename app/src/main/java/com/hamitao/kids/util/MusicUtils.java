...
/*    public static List<Music> scanMusic(Context context) {
        ...
        long filterSize = ParseUtils.parseLong(PropertiesUtil.getInstance().getString(PropertiesUtil.SpKey.Filter_Size,"0")) * 1024;
        long filterTime = ParseUtils.parseLong(PropertiesUtil.getInstance().getString(PropertiesUtil.SpKey.Filter_Time,"0")) * 1000;
