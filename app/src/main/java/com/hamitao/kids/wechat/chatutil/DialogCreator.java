package com.hamitao.kids.wechat.chatutil;
...
import com.hamitao.kids.wechat.HandleResponseCode;
...
public class DialogCreator {
    ...
    public static Dialog createResendDialog(Context context, View.OnClickListener listener) {
        ...
        View view = LayoutInflater.from(context).inflate(
                IdHelper.getLayout(context, "dialog_tips"), null);
        dialog.setContentView(view);
        Button cancelBtn = (Button) view.findViewById(IdHelper.getViewID(context, "tv_cancel"));
        Button resendBtn = (Button) view.findViewById(IdHelper.getViewID(context, "tv_confirm"));
...
//                        intent.setClass(context, ResetPasswordActivity.class);
    ...
    public static void createForwardMsg(final Context context, int mWidth, final boolean isSingle, final Conversation conv,
        ...
        final Message message = BaseApplication.forwardMsg.get(0);
