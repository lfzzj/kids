package com.hamitao.kids.chat.manager;
...
//            imgBg.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.yuyin_voice_1));
            ...
            imgBg.setBackground(mContext.getResources().getDrawable(R.drawable.yuyin_voice_1));
    ...
    public void wantToCancel() {
        if (mDialog != null && mDialog.isShowing()) {
            ...
            imgBg2.setBackground(mContext.getResources().getDrawable(R.drawable.yuyin_cancel));
            tipsTxt2.setText(R.string.want_to_cancle);
            tipsTxt2.setBackgroundColor(mContext.getResources().getColor(R.color.red));
    ...
    public void tooShort() {
        if (mDialog != null && mDialog.isShowing()) {
            ...
            imgBg.setVisibility(View.GONE);
            tipsTxt.setVisibility(View.GONE);
            imgBg2.setBackground(mContext.getResources().getDrawable(R.drawable.yuyin_gantanhao));
