...
public class UIDisplayer {
    ...
    public UIDisplayer(Activity activity) {
        view = LayoutInflater.from(activity).inflate(R.layout.dialog_display, null);
       /* this.imageView = imageView;
        this.bar = bar;
        this.infoView = infoView;*/
        this.imageView = view.findViewById(R.id.iv_display);
        this.bar = view.findViewById(R.id.pb_display);
        this.infoView = view.findViewById(R.id.tv_display);
